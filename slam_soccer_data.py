...
class PtzSlam:
    ...
    def test_orb(self):
        ...
        #     print("%d match"% i, matches[i].queryIdx,  matches[i].trainIdx)
    ...
    def get_seq3_image(self, index):
        filename = "0" + str(index * 3 + 515) + ".jpg"
        print(filename)
        img = cv.imread("./two_point_calib_dataset/highlights/seq3/" + filename)
        orb = cv.ORB_create()
    ...
    def main_algorithm(self):
        ...
        first_frame_kp, first_frame_des = self.get_seq3_image(0)
